...
// Static FAQ entries for the Seller Dashboard
const SELLER_DASHBOARD_FAQ_ITEMS = [
  // Listing Status
  {
...
function SellerDashboardFAQ() {
  return (
    <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
      {SELLER_DASHBOARD_FAQ_ITEMS.map((item, index) => (
        <div
          key={index} // unique key for each FAQ entry
          className="pb-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0"
        >
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">
            {index + 1}. {item.question}
          </h3>
          {/* whitespace-pre-line keeps the manual line breaks in the answer text */}
