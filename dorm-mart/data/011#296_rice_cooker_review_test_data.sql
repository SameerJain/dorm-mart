...
-- Creates a completed purchase: Rice Cooker sold by testuserschedulered@buffalo.edu to testuser@buffalo.edu
...
-- Buyer (testuser@buffalo.edu) reviews seller (testuserschedulered@buffalo.edu)
-- Note: Ensure rice-cooker-review-image.jpg exists in /media/review-images/ directory
-- You may need to copy it from data/test-images/ to media/review-images/ manually
INSERT INTO product_reviews (
  ...
  5.0,
  4.5,
  'This rice cooker is so great! Look at what I made.',
